...
R9DS의 아두이노 전압을 인가하고, 우측 버튼을 눌러서 송신기 AT9과 바인딩 작업 후에 바인딩 작업이 완료가 되면, 
AT9 송신기에서 MODE -> AUX/CH에서 사용자가 직접적으로 송신기의 스위치를 임의의 **채널 셋팅 가능**.
(사용자 마다 채널이 상이하기 때문에 반드시 확인 필요!!!)
